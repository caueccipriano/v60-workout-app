window.TRACO_BRAND={name:'Traço',version:'2.0.0',legacyDataPrefix:'v60_'};
...
renderSettings=function(){
  ...
  if(intro&&!document.querySelector('.traco-about-card')){
    intro.insertAdjacentHTML('afterend','<section class="traco-about-card"><img src="./assets/traco-icon-180.png" alt=""><div><span>seu app</span><b>Traço</b><small>treino · evolução · constância · versão 2.0.0</small></div></section>');
  }
