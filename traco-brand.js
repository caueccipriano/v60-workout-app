...
renderSettings=function(){
  ...
  if(intro&&!document.querySelector('.traco-about-card')){
    intro.insertAdjacentHTML('afterend','<section class="traco-about-card"><img src="./assets/icon.svg?v=290" alt=""><div><span>seu app</span><b>Traço</b><small>treino · evolução · constância · versão 2.4.1</small></div></section>');
  }
