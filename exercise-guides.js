const V60_GUIDES = {
  ...
  'crucifixo-baixo-alto': {motion:'fly-up',accent:'blue',focus:'peito superior',cue:'trajetória em arco para cima',tips:['inicie com as polias baixas','faça um arco levando as mãos para cima e para frente','mantenha o peito aberto durante o movimento'],error:'encolher os ombros durante a subida'},
  ...
  'crucifixo-reto': {motion:'fly',accent:'lime',focus:'peito',cue:'abre em arco e fecha na linha do peito',tips:['faça um arco suave com os cotovelos semiflexionados','mantenha tensão no peito o tempo todo','una as mãos à frente sem bater'],error:'transformar o movimento em supino empurrando demais'},
  ...
  'core-leg-raise-ter': {motion:'legpress',accent:'orange',focus:'abdômen inferior · controle pélvico',cue:'sobe as pernas sem arquear a lombar',tips:['deite com a lombar apoiada e pernas juntas','eleve as pernas mantendo o abdômen firme','desça só até antes da lombar querer arquear'],error:'descer demais e perder contato da lombar com o banco'},
  'core-woodchop-qui': {motion:'pullover',accent:'orange',focus:'core · rotação controlada',cue:'gira costelas e quadril juntos',tips:['comece de lado para a polia alta','leve as mãos na diagonal usando o tronco como unidade','controle a volta sem deixar o cabo puxar você'],error:'puxar apenas com os braços e torcer a lombar'},
  'core-dead-bug-qui': {motion:'crunch',accent:'lime',focus:'core · anti-extensão',cue:'lombar colada no chão · alterna lados',tips:['comece com quadris e joelhos flexionados e braços acima do peito','estenda braço e perna opostos sem perder a lombar no chão','volte ao centro e alterne o lado'],error:'arquear a lombar quando braço e perna se afastam'}
};
