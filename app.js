...
function tracoOpenBodyEditor(id){
  ...
  $('#tracoSaveBodyEdit').onclick=()=>{
    const updated={...entry,date:$('#tracoBodyDate').value,weight:$('#tracoBodyWeight').value,waist:$('#tracoBodyWaist').value,chest:$('#tracoBodyChest').value,shoulders:$('#tracoBodyShoulders').value,arm:$('#tracoBodyArm').value};
    if(!updated.date)return toast('escolhe uma data');
    if(!updated.weight&&!updated.waist&&!updated.chest&&!updated.shoulders&&!updated.arm)return toast('preenche pelo menos uma medida');
